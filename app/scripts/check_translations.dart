...
void main(List<String> args) {
  ...
  if (!untranslatedFile.existsSync()) {
    print('✅ No untranslated messages file found - all translations are complete!');
    exit(0);
  }
  ...
  try {
    ...
    if (untranslated.isEmpty) {
      print('✅ No untranslated messages found - all translations are complete!');
      exit(0);
    }
    ...
    print('💡 Add the missing translations to lib/l10n/app_${untranslated.keys.first}.arb');
