...
class GeminiApiService {
  ...
  Future<String> getTranscriptionPrompt() async {
    try {
      ...
      final promptData =
          await rootBundle.loadString('docs/speech_transcription_prompts.md');
      ...
      throw Exception(
          'Failed to load transcription prompts from markdown file: $e');
    }
  }
  ...
  Future<String> processAudioFile(String audioPath) async {
    ...
    try {
          ...
          if (result['promptFeedback'] != null) {
            ...
            if (blockReason != null) {
              throw GeminiApiException(
                  'Content was blocked by Gemini (likely false positive): $blockReason');
            }
          }
        }
      }
      ...
      throw e is GeminiApiException
          ? e
          : GeminiApiException('Audio processing failed: $e');
    }
  }
          ...
          'contents': [
            {
              'parts': [
                {
                  'text':
                      "Please transcribe and improve this speech recognition result. If it's in Lithuanian, keep it in Lithuanian. If it's unclear or seems like gibberish, try to interpret what the person might have said. Keep your response concise and direct: '$text'"
                }
              ]
            }
          ],
